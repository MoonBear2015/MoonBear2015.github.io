...
// 季語：虫
class Gene_tema32 extends Gene_Poemer {
    constructor() {
        super('@TM32', '@PIC_TEMA@');
        this.Add_cods(cods_bug);
        this.Add_cods(cods_butterfly);
    }
}
// 季語：蝶
class Gene_tema33 extends Gene_Poemer {
    constructor() {
        super('@TM33', '@PIC_TEMA@');
        this.Add_cods(cods_butterfly);
    }
...
// 季語：ペン
class Gene_tema36 extends Gene_Poemer {
    constructor() {
        super('@TM36', '@PIC_TEMA@');
        this.Add_cods(cods_pen);
    }
}
// 季語：おもちゃ
class Gene_tema37 extends Gene_Poemer {
    constructor() {
        super('@TM37', '@PIC_TEMA@');
...
class Gene_sent extends Gene_Poemer {
    constructor() {
        ...
        this.Add_cods(cods_ad_sense_p);
        this.Add_cods(cods_ad_sense_n);
