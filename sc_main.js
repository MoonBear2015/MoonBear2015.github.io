...
function set_main() {
    ...
    let msgs = [
        ...
        // '@CLASS@にとって最大の悲劇は、<br>@ANSWER@によって@THINK@されることだ。'
        // ,
        // // ミケランジェロ（イタリアのルネサンス期の芸術家 / 1475～1564）
        // // ささいなことが完璧を生む。しかし、完璧はささいなことではない。
        // '@KEI1@ことが@CLASS@を生む。<br>しかし、<br>@CLASS@は@KEI1@ことではない。'
        // ,
        // // ロダン（フランスの彫刻家『考える人』の作者 / 1840～1917）
        // // 経験を賢く生かすならば、何事も無駄ではない。
        // '@CLASS@を賢く生かすならば、<br>@CLASS@も無駄ではない。'
        // ,
        ...
        // '@MOVE@前から叩かれてしまうこともあります。<br>それでも@MOVE@のがほんとうの@THINK@です。'
        // ,
        ...
        // '@KEI1@ものでも、<br>@KEI1@ものでも、<br>@CLASS@には感謝しましょう。'
        // ,
