...
function set_main() {
    ...
    let msgs = [
        ...
        '@THINK@とは、<br>@THINK@以外のことを<br>@KEID1@考えているときにあるんだよ。',
        ...
        '@CLASS@は@THEY@に、<br>@THINK@して欲しいなんて思っていません。<br>ただ、@THINK@することを望んでいるだけよ。',
        ...
        'あせってはいけません。<br>ただ、@NICK@のように、<br>@KEID1@進んで行くのが@CLASS@です',
        ...
        // '@THEY@が@KEI1@気分でいられるのは、<br>@KEI1@@CLASS@が@THEY@を@KEID1@担ってくれているからに過ぎない。'
        ,
        // モンテスキュー（フランスの哲学者 / 1689～1755）
        // 世の中で成功を収めるには、馬鹿のように見せかけ、利口に行動することである。
        '@CLASS@が成功を収めるには、<br>@KEI1@@NICK@に見せかけ、<br>@KEID1@行動することである。',
        ...
        '@CLASS@とは、<br>@THINK@する@CLASS@じゃなくて、<br>@KEI1@ことをする@CLASS@。<br>だから@CLASS@は@THEY@がきたら必ず@THINK@するわ。',
        ...
        '@KEI1@ことにも@ANSWER@がある。<br>@CLASS@がそれを見つけられるかどうかさ。',
        ...
        '@CLASS@を@KEID1@生かすならば、<br>@CLASS@も@KEI2@ではない。',
