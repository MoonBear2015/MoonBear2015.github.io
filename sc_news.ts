...
class selector_do_power extends SctItm_Selector implements ISctItm_Selector{
    constructor(){
        super('@DOPOWER@');
        this.Add(itms_do_power);
    }
...
// （固定）動名詞 の～
class locker_do_power extends SctItm_SelectLocker implements ISctItm_Selector{
    constructor(){
...
class selector_do_poor extends SctItm_Selector implements ISctItm_Selector{
    constructor(){
        super('@DOPOOR@');
        this.Add(itms_do_poor);
    }
...
// （固定）動名詞 の～
class locker_do_poor extends SctItm_SelectLocker implements ISctItm_Selector{
    constructor(){
...
class selector_nickStrong extends SctItm_Selector implements ISctItm_Selector {
    constructor(){
        super('@NICKSTRONG@');
        this.Add(itms_nickStrong);
    }
}
class selector_nickPoor extends SctItm_Selector implements ISctItm_Selector {
    constructor(){
        super('@NICKPOOR@');
        this.Add(itms_nickPoor);
    }
...
class selector_powerItem extends SctItm_Selector implements ISctItm_Selector {
    constructor(){
        super('@POWERITEM@');
...
class locker_powerItem extends SctItm_SelectLocker implements ISctItm_Selector {
    constructor(){
        super('@L_POWERITEM@');
        this.Add(cods_to_itms(cods_weapon).slice(1));
        this.Add(cods_to_itms(cods_gun).slice(1));
