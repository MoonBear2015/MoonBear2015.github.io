...
const   cods_move = [
    ...
    ,
    new SctCod_Mv('|進|すす|める')
    ,
    new SctCod_Mv('|戻|もど|る')
    ,
    new SctCod_Mv('|戻|もど|す')
    ,
    new SctCod_Mv('|上|あ|がる')
    ,
    new SctCod_Mv('|上|あ|げる')
    ,
    new SctCod_Mv('|下|さ|がる')
    ,
    new SctCod_Mv('|下|さ|げる')
    ,
...
const   cods_ad_power = [
    new SctCod_Mv('|強|つよ|い')
    ,
    new SctCod_Mv('|力強|ちからづよ|い')
    ,
    ...
    ,
    new SctCod_Mv('|頼|たの|もしい')
];

const   cods_adv_power = [
    new SctCod_Mv('|強|つよ|く')
    ,
    new SctCod_Mv('|力強|ちからづよ|く')
    ,
    new SctCod_Mv('|勇|いさ|ましく')
    ,
    new SctCod_Mv('|固|かた|く')
    ,
    new SctCod_Mv('|凄|すご|く')
    ,
    new SctCod_Mv('|物凄|ものすご|く')
    ,
    new SctCod_Mv('|頼|たの|もしく')
];

const   cods_ad_low = [
    new SctCod_Mv('|弱|よわ|い')
    ,
    new SctCod_Mv('か|弱|よわ|い')
    ,
    new SctCod_Mv('|力無|ちからな|い')
    ,
    new SctCod_Mv('|柔|やわら|かい')
    ,
    new SctCod_Mv('|頼|たよ|りない')
];

const   cods_adv_low = [
    new SctCod_Mv('|弱|よわ|く')
    ,
    new SctCod_Mv('か|弱|よわ|く')
    ,
    new SctCod_Mv('|力無|ちからな|く')
    ,
    new SctCod_Mv('|柔|やわら|かく')
    ,
...
const   cods_ad_big = [
    ...
    ,
    new SctCod_Mv('|太|ふと|い')
    ,
    new SctCod_Mv('|図太|ずぶと|い')
    ,
    new SctCod_Mv('デカい')
    ,
...
const   cods_adv_big = [
    ...
    ,
    new SctCod_Mv('|太|ふと|く')
    ,
    new SctCod_Mv('|図太|ずぶと|く')
    ,
    new SctCod_Mv('デカく')
    ,
    new SctCod_Mv('|馬鹿|ばか|デカく')
];

const   cods_ad_small = [
    new SctCod_Mv('|小|ちい|さい')
    ,
    new SctCod_Mv('|細|ほそ|い')
    ,
    new SctCod_Mv('か|細|ぼそ|い')
    ,
    new SctCod_Mv('ちっちゃい')
];
...
const   cods_km = [
    ...
    ,
    new SctCod_Km('|清楚|せいそ|')
    ,
    new SctCod_Km('|清廉潔白|せいれんけっぱく|')
    ,
    new SctCod_Km('|赤裸々|せきらら|')
    ,
    new SctCod_Km('|爽快|そうかい|')
    ,
    new SctCod_Km('|率直|そっちょく|')
    ,
    new SctCod_Km('|粗暴|そぼう|')
    ,
    new SctCod_Km('|素朴|そぼく|')
    ,
    new SctCod_Km('|怠慢|たいまん|')
    ,
    new SctCod_Km('|淡泊|たんぱく|')
    ,
    ...
    ,
    new SctCod_Km('|破廉恥|はれんち|')
    ,
    new SctCod_Km('|反抗的|はんこうてき|')
    ,
    ...
    ,
    new SctCod_Km('|悲痛|ひつう|')
    ,
    new SctCod_Km('|非道|ひどう|')
    ,
    new SctCod_Km('|美味|びみ|')
    ,
    new SctCod_Km('|微妙|びみょう|')
    ,
    new SctCod_Km('|美妙|びみょう|')
    ,
    new SctCod_Km('|非論理的|ひろんりてき|')
    ,
    new SctCod_Km('|卑猥|ひわい|')
    ,
    ...
    ,
    new SctCod_Km('|無傷|むきず|')
    ,
    new SctCod_Km('|無慈悲|むじひ|')
    ,
    new SctCod_Km('|無邪気|むじゃき|')
    ,
    new SctCod_Km('|無情|むじょう|')
    ,
    new SctCod_Km('|無尽蔵|むじんぞう|')
    ,
    new SctCod_Km('|無責任|むせきにん|')
    ,
    new SctCod_Km('|無念|むねん|')
    ,
    new SctCod_Km('|無能|むのう|')
    ,
    new SctCod_Km('|無用|むよう|')
    ,
    new SctCod_Km('|名誉|めいよ|')
    ,
    new SctCod_Km('|迷惑|めいわく|')
    ,
    new SctCod_Km('|滅茶苦茶|めちゃくちゃ|')
    ,
    ...
    ,
    new SctCod_Km('|優良|ゆうりょう|')
    ,
    new SctCod_Km('|愉快|ゆかい|')
    ,
    ...
    ,
    new SctCod_Km('|冷酷|れいこく|')
    ,
    new SctCod_Km('|冷淡|れいたん|')
    ,
    new SctCod_Km('|劣悪|れつあく|')
    ,
    new SctCod_Km('|老獪|ろうかい|')
    ,
    new SctCod_Km('|露骨|ろこつ|')
    ,
    new SctCod_Km('|論外|ろんがい|')
    ,
    new SctCod_Km('|猥褻|わいせつ|')
    ,
...
const   itms_what = [
    ...
    ,
    new SctItm('@L_COUNTRY@空軍','WHAT/aircraft.jpg')
    ,
    new SctItm('@L_COUNTRY@陸軍','WHAT/tank.jpg')
    ,
    new SctItm('@L_COUNTRY@警察','WHAT/police.jpg')
    ,
...
const   itms_do = [
    ...
    // ,
    new SctItm('|孤立|こりつ|','DO/Lonly2.jpg')
    ,
    // new SctItm('消滅','DO/Dis.jpg')
    // ,
    new SctItm('|感染|かんせん|','DO/infection.jpg')
    ,
    // new SctItm('暴走','DO/Wild.jpg')
    // ,
    // new SctItm('発狂','DO/crazy.jpg')
    // ,
    new SctItm('|洗脳|せんのう|','DO/brainwash.jpg')
    ,
    new SctItm('|終焉|しゅうえん|','DO/end.jpg')
    ,
    new SctItm('|衰退|すいたい|','DO/decline.jpg')
    ,
    // new SctItm('滅亡','DO/Destruction.jpg')
    // ,
    // new SctItm('自滅','DO/self.jpg')
    // ,
    new SctItm('|困惑|こんわく|','DO/panic.jpg')
    ,
    new SctItm('|混乱|こんらん|','DO/panic.jpg')
    // ,
    ...
    ,
    new SctItm('|堕落|だらく|','DO/depra.jpg')
    ,
    new SctItm('|失業|しつぎょう|','DO/lostjob.jpg')
    ,
    new SctItm('|支配|しはい|','DO/mad.jpg')
    ,
    new SctItm('|追放|ついほう|','DO/getout.jpg')
    ,
    new SctItm('|虐待|ぎゃくたい|','DO/depression.jpg')
    ,
    new SctItm('|束縛|そくばく|','DO/sm.jpg')
    ,
    new SctItm('|拘束|こうそく|','DO/sm.jpg')
    ,
    new SctItm('|否定|ひてい|','DO/no.jpg')
    ,
    new SctItm('|警告|けいこく|','DO/warning.jpg')
    // ,
    // new SctItm('漏洩','DO/infoleak.jpg')
    ,
    new SctItm('|復讐|ふくしゅう|','DO/revenge.jpg')
    ,
    new SctItm('|号泣|ごうきゅう|','DO/cry.jpg')
    ,
    new SctItm('|荒廃|こうはい|','DO/devastation.jpg')
    ,
    // new SctItm('腐敗','DO/oldtimer.jpg')
    // ,
    new SctItm('|敗北|はいぼく|','DO/lost.jpg')
    ,
    new SctItm('|降伏|こうふく|','DO/lose.jpg')
    ,
    new SctItm('|逃走|とうそう|','DO/run.jpg')
    ,
    new SctItm('|迷走|めいそう|','DO/panicrun.png')
    ,
    new SctItm('|抗議|こうぎ|','DO/demo.jpg')
    ,
    new SctItm('|侮辱|ぶじょく|','DO/insult.jpg')
    ,
    // new SctItm('退化','DO/Degeneration.jpg')
    // ,
    new SctItm('|失望|しつぼう|','DO/disappointment.jpg')
    ,
    new SctItm('|軽蔑|けいべつ|','DO/contempt.jpg')
    ,
    new SctItm('|驚愕|きょうがく|','DO/Surprise.jpg')
    ,
    new SctItm('|沈没|ちんぼつ|','DO/sinking.jpg')
    ,
    new SctItm('|墜落|だらく|','DO/plane.jpg')
    ,
    new SctItm('|閉鎖|へいさ|','DO/KeepOut.jpg')
    ,
    new SctItm('|占領|せんりょう|','DO/occupation.jpg')
    ,
    new SctItm('|失敗|しっぱい|','DO/error.jpg')
    ,
    new SctItm('|失恋|しつれん|','DO/brokenheart.jpg')
    ,
    new SctItm('|朝寝坊|あさねぼう|','DO/overslept.jpg')
    ,
    new SctItm('|暗殺|あんさつ|','DO/kill.jpg')
    ,
    new SctItm('|激怒|げきど|','DO/angry.jpg')
    ,
    new SctItm('|炎上|えんじょう|','DO/burn.png')
    ,
    // new SctItm('閉店','DO/close.jpg')
    // ,
    new SctItm('|終了|しゅうりょう|','DO/end2.jpg')
    ,
    new SctItm('|謝罪|しゃざい|','DO/column.png')
    //
    // posi 
    //
    ,
    new SctItm('|誕生|たんじょう|','DO/birth.jpg')
    ,
    new SctItm('|復活|ふっかつ|','DO/rebirth.jpg')
    ,
    new SctItm('|成長|せいちょう|','DO/grow.jpg')
    ,
    new SctItm('|成功|せいこう|','DO/success.jpg')
    ,
    new SctItm('|承認|しょうにん|','DO/yes.jpg')
    ,
    new SctItm('|解放|かいほう|','DO/release.jpg')
    ,
    new SctItm('|独立|どくりつ|','DO/independence.jpg')
    ,
    new SctItm('|賞賛|しょうさん|','DO/praise.jpg')
    ,
    new SctItm('|祝福|しゅくふく|','DO/bless.jpg')
    ,
    new SctItm('|救助|きゅうじょ|','DO/rescue.jpg')
    ,
    new SctItm('|生還|せいかん|','DO/surviving.jpg')
    ,
    new SctItm('|達成|たっせい|','DO/affir.jpg')
    ,
    new SctItm('|勝利|しょうり|','DO/vict.jpg')
    ,
    new SctItm('|反撃|はんげき|','DO/counterattack.jpg')
    ,
    new SctItm('|優勝|ゆうしょう|','DO/topwin.jpg')
    ,
    new SctItm('|発明|はつめい|','DO/invention.jpg')
    ,
    new SctItm('|開発|かいはつ|','DO/debelop.jpg')
    ,
    new SctItm('|分析|ぶんせき|','DO/analysis.jpg')
    ,
    new SctItm('|革命|かくめい|','DO/revolution.jpg')
    ,
    new SctItm('|移住|いじゅう|','DO/emigration.jpg')
    ,
    new SctItm('|降臨|こうりん|','DO/advent.jpg')
    ,
    new SctItm('|覚醒|かくせい|','DO/awaken.jpg')
    ,
    new SctItm('|引退|いんたい|','DO/solo.jpg')
    ,
    new SctItm('|多様化|たようか|','DO/personal.jpg')
    ,
    new SctItm('|恋|こい|','DO/love.jpg')
    ,
    new SctItm('|溺愛|できあい|','DO/love2.jpg')
    ,
    new SctItm('|近代化|きんだいか|','DO/develop.jpg')
    ,
    new SctItm('|巨大化|きょだいか|','DO/Giant.jpg')
    ,
    new SctItm('|映画化|えいがか|','DO/movie.jpg')
    ,
    new SctItm('アニメ|化|か|','DO/animated.jpg')
    ,
    new SctItm('|機械化|きかいか|','DO/Mechanization.jpg')
    ,
    new SctItm('|進化|しんか|','DO/evolution2.jpg')
    ,
    new SctItm('|開花|かいか|','DO/openflower.jpg')
    ,
    new SctItm('|増殖|ぞうしょく|','DO/Multiple.jpg')
    ,
    ...
    // ,
    new SctItm('|爆笑|ばくしょう|','DO/laugh2.jpg')
    ,
    new SctItm('|大笑|おおわら|い','DO/laugh2.jpg')
    ,
    new SctItm('|結婚|けっこん|','DO/wedding.jpg')
    ,
    new SctItm('コンプリート','DO/complete.jpg')
    ,
    new SctItm('|正常化|せいじょうか|','DO/clean.jpg')
    ,
    new SctItm('|浄化|じょうか|','DO/clean.jpg')
    ,
    new SctItm('|期待|きたい|','DO/blur.jpg')
    ,
    new SctItm('デビュー','DO/Debut.jpg')
    ,
    new SctItm('|初登場|はつとうじょう|','DO/Debut.jpg')
    ,
    new SctItm('|殿堂入|でんどうい|り','DO/crown.jpg')
]

const   itms_do_power = [
    new SctItm('|爆発|ばくはつ|','DO/bomb.jpg')
    ,
    new SctItm('|暴発|ぼうはつ|','DO/bomb.jpg')
    ,
    new SctItm('|大爆発|だいばくはつ|','DO/bomb.jpg')
    ,
    new SctItm('|暴走|ぼうそう|','DO/Wild.jpg')
    ,
    new SctItm('|発狂|はっきょう|','DO/crazy.jpg')
    ,
    new SctItm('|炎上|えんじょう|','DO/burn.png')
    ,
    new SctItm('フィーバー','DO/fever.jpg')
    ,
    new SctItm('|大|おお|はしゃぎ','DO/fever.jpg')
]

const   itms_do_poor = [
    new SctItm('|壊滅|かいめつ|','DO/break.jpg')
    ,
    new SctItm('|死滅|しめつ|','DO/dead.jpg')
    ,
    new SctItm('|崩壊|かいめつ|','DO/Collapse.jpg')
    ,
    new SctItm('|絶望|ぜつぼう|','DO/Lonly.jpg')
    ,
    new SctItm('|消滅|しょうめつ|','DO/Dis.jpg')
    ,
    new SctItm('|滅亡|めつぼう|','DO/Destruction.jpg')
    ,
    new SctItm('|自滅|じめつ|','DO/self.jpg')
    ,
    new SctItm('|腐敗|ふはい|','DO/oldtimer.jpg')
    ,
    new SctItm('|退化|たいか|','DO/Degeneration.jpg')
    ,
    new SctItm('|閉店|へいてん|','DO/close.jpg')
]
...
const   itms_class = [
    ...
    new SctItm('ホステス')
    ,
    new SctItm('|飴細工師|あめざいくし|')
    ,
    new SctItm('マッチ売り')
    ,
    new SctItm('|魔法使|まほうつか|い')
    ,
    new SctItm('|魔法少女|まほうしょうじょ|')
    ,
    new SctItm('|黒魔術師|くろまじゅつし|')
    ,
    new SctItm('|祈祷師|きとうし|')
    ,
    new SctItm('|悪魔払|あくまばら|い師')
    ,
    new SctItm('インディアン')
    ,
    new SctItm('カウボーイ')
    ,
    new SctItm('|賞金稼|しょうきんかせ|ぎ')
    ,
    new SctItm('|看板娘|かんばんむすめ|')
    ,
    new SctItm('カメラ屋')
    ,
    new SctItm('税理士')
    ...
    new SctItm('忍者')
    ,
    new SctItm('|抜|ぬ|け|忍|にん|')
    ,
    new SctItm('|諜報員|ちょうほういん|')
    ,
    new SctItm('狙撃兵')
    ,
    new SctItm('スナイパー')
    ...
    new SctItm('セールスマン')
    ,
    new SctItm('|庖丁人|ほうちょうにん|')
    ,
    new SctItm('|用心棒|ようじんぼう|')
    ,
    new SctItm('ヤクザ')
    ,
    new SctItm('チンピラ')
    ...
    new SctItm('ギャンブラー')
    ,
    new SctItm('|花火職人|はなびしょくにん|')
    ,
    new SctItm('皿洗い')
    ,
    new SctItm('|薬剤師|やくざいし|')
    ,
    new SctItm('ペンキ屋')
    ,
    new SctItm('パン屋')
    ...
    // new SctItm('@STAR@人')
    // ,
    new SctItm('|秘密探偵|ひみつたんてい|')
    ,
    new SctItm('|人魚|にんぎょ|')
    ,
    new SctItm('|半魚人|はんぎょじん|')
    ,
    new SctItm('|人狼|じんろう|')
    ,
    new SctItm('|狼男|おおかみおとこ|')
    ,
    new SctItm('|吸血鬼|きゅうけつき|')
    ,
    new SctItm('|化|ば|け|猫|ねこ|')
    ,
    new SctItm('|河童|かっぱ|')
    ,
    new SctItm('ゾンビ')
...
const   itms_shop = [
    ...
    ,
    new SctItm('BICYCLE','SHOP/BICYCLE02.jpg','自転車')
    ,
    ...
    ,
    new SctItm('COMPUTER','SHOP/COMPUTER01.jpg','コンピューター')
    ,
    new SctItm('COMPUTER','SHOP/COMPUTER02.jpg','コンピューター')
    ,
    ...
    ,
    new SctItm('COMPUTER','SHOP/COMPUTER06.jpg','コンピューター')
    ,
    ...
    ,
    new SctItm('SMARTPHONE','SHOP/PHONE04.jpg','スマートフォン')
    ,
    new SctItm('SMARTPHONE','SHOP/PHONE05.jpg','スマートフォン')
    ,
    new SctItm('TYPEWRITER','SHOP/TYPEWRITER.jpg','タイプライター')
    ,
    new SctItm('TOASTER','SHOP/TOASTER.jpg','トースター')
    ,
    new SctItm('TRAIN','SHOP/TRAIN.jpg','機関車')
    ,
...
const   itms_book = [
    ...
    new SctItm('@L_DID@')
    ,
    new SctItm('@L_DID@@DIDEND@@L_WHAT@')
    ,
    new SctItm('@L_DID@@DIDEND@@L_CHAR@')
    ,
...
const   itms_hero_type = [
    new SctItm('戦士','HERO/Hero14.jpg')
    ,
    new SctItm('剣士','HERO/Hero03.jpg')
    ,
    new SctItm('騎士','HERO/Hero10.jpg')
    ,
    new SctItm('英雄','HERO/Hero09.jpg')
    ,
    new SctItm('少年','HERO/Hero02.jpg')
    ,
    new SctItm('少女','HERO/Hero03.jpg')
    ,
    new SctItm('王','HERO/Hero13.jpg')
    ,
    new SctItm('王者','HERO/Hero13.jpg')
    ,
    ...
    ,
    new SctItm('侯爵','HERO/Hero09.jpg')
    ,
    new SctItm('キング','HERO/Hero13.jpg')
    ,
    new SctItm('ライダー','HERO/Hero10.jpg')
    ,
    new SctItm('ファイター','HERO/Hero02.jpg')
    ,
    new SctItm('ロボ','HERO/Hero04.jpg')
    ,
    new SctItm('天使','HERO/Hero01.jpg')
    ,
    new SctItm('エンジェル','HERO/Hero01.jpg')
    ,
    new SctItm('レディー','HERO/Hero08.jpg')
    ,
    new SctItm('ボーイ','HERO/Hero02.jpg')
    ,
    new SctItm('ガール','HERO/Hero06.jpg')
    ,
    new SctItm('クイーン','HERO/Hero07.jpg')
    ,
...
const   itms_did = [
    ...
    ,
    new SctItm('@FOOD@をナイフとフォークで食べて')
    ,
    new SctItm('@FOOD@を手づかみで食べて')
    ,
    new SctItm('@FOOD@を丸呑みして食べて')
    ,
    new SctItm('@FOOD@を一口で平らげて')
    ,
    ...
    ,
    new SctItm('@MANYCHAR@に追われて')
    ,
    new SctItm('@MANYCHAR@に囲まれて')
    ,
    new SctItm('@MANYCHAR@にいじめられて')
    ,
    new SctItm('@MANYCHAR@に閉じ込められて')
    ,
    new SctItm('@MANYCHAR@に襲われて')
    ,
    new SctItm('@MANYCHAR@に@KEIP2@@WEAPON@で殺されかけて')
    ,
    new SctItm('@MANYCHAR@にもてはやされて')
    ,
    new SctItm('@MANYCHAR@に喝采されて')
    ,
    new SctItm('@MANYCHAR@を引き連れて')
    ,
    new SctItm('@MANYCHAR@を募集して')
    ,
    ...
    ,
    new SctItm('@GROUP@に騙されて')
    ,
    new SctItm('@GROUP@に何もかも奪われて')
    ,
    ...
    ,
    new SctItm('@GROUP@に加わって')
    ,
    new SctItm('@GROUP@に参入して')
    ,
    new SctItm('@GROUP@から@AWARD@を贈呈されて')
    ,
    ...
    ,
    new SctItm('@CHAR@から『@CALL@』と呼ばれて')
    ,
    new SctItm('@CHAR@から『@CALL@』と噂されて')
    ,
    new SctItm('@CHAR@から『@CALL@』と馬鹿にされて')
    ,
    new SctItm('@CHAR@から『@CALL@』と後ろ指を指されて')
    ,
    new SctItm('@CHAR@から『@CALL@』と讃えられて')
    ,
    new SctItm('@CHAR@から『@CALL@』と賞賛されて')
    ,
    new SctItm('@CHAR@から『@CALL@』とおだてられて')
    ,
    ...
    ,
    new SctItm('@ANIMALFROM@@ANIMAL@を連れて')
    ,
    new SctItm('@ANIMALFROM@@ANIMAL@に乗って')
    ,
    new SctItm('@ANIMALFROM@@ANIMAL@の散歩をして')
    ,
    new SctItm('@ANIMALFROM@@ANIMAL@に餌をやって')
    ,
    new SctItm('@ANIMALFROM@@ANIMAL@の体を洗って')
    ,
    new SctItm('@ANIMAL@狩りをして')
    ,
    new SctItm('@ANIMALFROM@@ANIMAL@に襲われて')
    ,
    new SctItm('@ANIMALFROM@@ANIMAL@と戦って')
    ,
    new SctItm('@ANIMALFROM@@ANIMAL@を退治して')
    ,
    new SctItm('@ANIMALFROM@@ANIMAL@を追い出して')
    ,
    new SctItm('@ANIMALFROM@@ANIMAL@を追い払って')
    ,
    new SctItm('@ANIMALFROM@@ANIMAL@の絵を描いて')
    ,
    new SctItm('@ANIMALFROM@@ANIMAL@を放し飼いにして')
    ,
    ...
    ,
    new SctItm('@SCHOOL@の@FESTIVAL@を開催して')
    ,
    new SctItm('@FESTIVAL@に参加して')
    ,
    new SctItm('@SCHOOL@の@FESTIVAL@に参加して')
    ,
    new SctItm('@FESTIVAL@を妨害して')
    ,
    new SctItm('@SCHOOL@の@FESTIVAL@を妨害して')
    ,
    ...
    ,
    new SctItm('@LANDMARK@を観光して')
    ,
    new SctItm('@LANDMARK@に走って')
    ,
    new SctItm('@LANDMARK@で寝泊まりして')
    ,
    new SctItm('@LANDMARK@に落書きして')
    ,
    new SctItm('@LANDMARK@を荒らし回って')
    ,
    new SctItm('@LANDMARK@を破壊して')
    ,
    new SctItm('@LANDMARK@を建て直して')
    ,
    new SctItm('@LANDMARK@を建築して')
    ,
    new SctItm('@LANDMARK@を改築して')
    ,
    new SctItm('@LANDMARK@を復旧して')
    ,
    new SctItm('@PLACE@で食事して')
    ,
    new SctItm('@PLACE@で眠って')
    ,
...
const   itms_did01_l = [
    ...
    ,
    new SctItm('@L_FOOD@をナイフとフォークで食べて')
    ,
    new SctItm('@L_FOOD@を手づかみで食べて')
    ,
    new SctItm('@L_FOOD@を丸呑みして食べて')
    ,
    new SctItm('@L_FOOD@を一口で平らげて')
    ,
...
const   itms_did02_l = [
    ...
    ,
    new SctItm('@L_GUN@を発射して')
    ,
    new SctItm('@L_GUN@を乱射して')
    ,
    new SctItm('@L_GUN@をぶっ放して')
...
const   itms_did_o = [
    ...
    ,
    new SctItm('@O_FOOD@をナイフとフォークで食べて')
    ,
    new SctItm('@O_FOOD@を手づかみで食べて')
    ,
    new SctItm('@O_FOOD@を丸呑みして食べて')
    ,
    new SctItm('@O_FOOD@を一口で平らげて')
    ,
...
const   itms_girlName = [
    new SctItm('|Софья|ソフィア|')
    ,
    new SctItm('|Мария|マリヤ|')
    ,
    new SctItm('|Анна|アンナ|')
    ,
    new SctItm('|Алиса|アリサ|')
    ,
    new SctItm('|Виктория|ヴィクトリア|')
    ,
    new SctItm('|Анастасия|アナスタシア|')
    ,
    new SctItm('|Полина|ポリーナ|')
    ,
    new SctItm('|Александра|アレクサンドラ|')
    ,
    new SctItm('|Елизавета|エリザヴェータ|')
    ,
    new SctItm('|Екатерина|エカチェリーナ|')
    ,            
    new SctItm('|聖子|せいこ|')
    ,
    new SctItm('|久美子|くみこ|')
    ...
    ,
    new SctItm('|Jane|ジェーン|')
    ,
    new SctItm('|Candy|キャンディー|')
    ,
    new SctItm('|Rinda|リンダ|')
    ,
    new SctItm('|Barbara|バーバラ|')
    ,
    new SctItm('|Elizabeth|エリザベス|')
    ,
    new SctItm('|Margaret|マーガレット|')
    ,
...
const   itms_heropic = [
    ...
    ,
    new SctItm('正義の','HERO/Hero03.jpg')
    ,
    new SctItm('ヒーロー','HERO/Hero04.jpg')
    ,
