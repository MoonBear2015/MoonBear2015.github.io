...
const   cods_km = [
    ...
    // ,
    // new SctCod_Km('|伸|の|び|伸|の|び')
    ,
    new SctCod_Km('のどか')
    ,
    new SctCod_Km('のどやか')
    // ,
    // new SctCod_Km('|沛然|はいぜん|')
    ,
    ...
    // ,
    // new SctCod_Km('|豊饒|ほうじょう|')
    // ,
    // new SctCod_Km('|呆然|ぼうぜん|')
    // ,
    // new SctCod_Km('|豊饒|ほうじょう|')
    ,
