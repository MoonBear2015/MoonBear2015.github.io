...
class NameMaker_ruby extends NameMaker {
    create() {
        return ruby_change(super.create());
    }
}
class NameMaker_kor extends NameMaker_ruby {
    constructor() {
        super('');
        this.name01 = [
            '|김|キム|',
...
class NameMaker_cha extends NameMaker_ruby {
    constructor() {
        super('');
        this.name01 = [
            '|王|ワン|',
...
class NameMaker_rus extends NameMaker_ruby {
    constructor() {
        super(' ');
        this.name01 = [
            '|Александр|アレクサンドル|',
...
class NameMaker_jpn extends NameMaker_ruby {
    constructor() {
        super('');
        this.name01 = [
            '|鈴木|すずき|',
...
class NameMaker_eng extends NameMaker_ruby {
    constructor() {
        super(' ');
        this.name01 = [
            '|John|ジョン|',
