...
// （固定）商品
class locker_faouscompany extends SctItm_SelectLocker {
    constructor() {
...
class locker_AwardGet2 extends SctItm_SelectLocker {
    constructor() {
        super('@L_AWARDGET2@', '', '@ICON_TECH@');
        this.Add(itms_AwardGet2);
    }
}
class locker_AwardGet3 extends SctItm_SelectLocker {
    constructor() {
