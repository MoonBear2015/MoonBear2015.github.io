...
class selector_subtitle02 extends SctItm_Selector {
    constructor() {
        ...
        this.itms = [
            new SctItm('@L_DO@@END02B@@CHAR@'),
            new SctItm('@L_DO@@END02B@@CHAR@の@THINK@'),
...
class locker_manychar extends SctItm_SelectLocker {
    constructor() {
        ...
        this.itms = [
            ...
            new SctItm('@MANY@@KEI@@L_CHAR@')
        ];
    }
}
class selector_bigName extends SctItm_Selector {
    constructor() {
        super('@BIGNAME@');
        this.itms = [
...
class selector_newsC01 extends SctItm_Selector {
    constructor() {
        ...
        this.itms = [
            ...
            new SctItm('@MANYPEOPLE@が@KEID@@L_DO@@END01B@'),
            new SctItm('@MANYPEOPLE@による@KEI@@KEY@が@SIZE@@END01B@'),
...
class selector_comment2 extends SctItm_Selector {
    constructor() {
        ...
        this.itms = [
            ...
            new SctItm('@L_WHAT@で私が@DID@ていると、@L_MANYCHAR@が@DID@@DIDEND@@END02D1@'),
            new SctItm('私が@DID@@DIDEND@とき、@L_WHAT@で@L_MANYCHAR@が@DID@@DIDEND@@END02D1@'),
            new SctItm('私が@DID@ていると、@L_WHAT@で@L_MANYCHAR@が@DID@@DIDEND@@END02D1@'),
            new SctItm('私が@L_WHAT@で@DID@ていると、@L_MANYCHAR@が@DID@@DIDEND@@END02D1@'),
...
class selector_doing01 extends SctItm_Selector {
    constructor() {
        ...
        this.itms = [
            ...
            new SctItm('@DOING02@'),
            new SctItm('@DOING02@'),
            new SctItm('@CHAR@と一緒に@DOING02@'),
            new SctItm('@CHAR@と@DOING02@'),
