...
class selector_random_NUM2TO100 extends ItmArray {
    constructor() {
        super();
...
class selector_random_NUMPAY extends ItmArray {
    constructor() {
        super();
        this.itm_key = "@NUMPAY@";
        this.itm_key2 = "";
...
class selector_char extends SctItm_Selector {
    constructor() {
        super('@CHAR@');
        this.itms = [
            new SctItm('@CLASS@')
...
class locker_char extends SctItm_SelectLocker {
    constructor() {
        super('@L_CHAR@');
        this.itms = [
            new SctItm('@L_CLASS@')
...
class selector_manychar extends SctItm_Selector {
    constructor() {
        super('@MANYCHAR@');
        this.itms = [
            new SctItm('@MANYMAN@@THEY@'),
...
class locker_manychar extends SctItm_SelectLocker {
    constructor() {
        super('@L_MANYCHAR@');
        this.itms = [
...
class selector_newsC01 extends SctItm_Selector {
    constructor() {
        super('@NEWS_C01@');
        this.itms = [
...
class selector_newsC02 extends SctItm_Selector {
    constructor() {
        super('@NEWS_C02@');
        this.itms = [
...
class selector_newsQ01 extends SctItm_Selector {
    constructor() {
        super('@NEWS_Q01@');
        this.itms = [
...
class selector_why extends SctItm_Selector {
    constructor() {
        super('@WHY@');
        this.itms = [
            new SctItm('何故'),
...
class selector_why2 extends SctItm_Selector {
    constructor() {
        super('@WHY2@');
        this.itms = [
            new SctItm('何故か'),
...
class selector_TimeFront extends SctItm_Selector {
    constructor() {
        super('@TIMEFRONT@');
        this.itms = [
            new SctItm(''),
...
class selector_DIDFRONT extends SctItm_Selector {
    constructor() {
        super('@DIDFRONT@');
        this.itms = [
            new SctItm(''),
...
class selector_end02d1 extends SctItm_Selector {
    constructor() {
        super('@END02D1@');
        this.itms = [
            new SctItm('のだ'),
...
class selector_kp2 extends SctItm_Selector {
    constructor() {
        ...
        this.itms = [
            new SctItm('@KEIP@'),
            new SctItm('@KEIDP@て@KEIP@'),
            new SctItm('@KEIMP@で@KEIP@'),
            new SctItm('@KEIMP@な'),
            new SctItm('@KEIDP@て@KEIMP@な'),
            new SctItm('@KEIMP@で@KEIMP@な'),
...
class selector_kp3 extends SctItm_Selector {
    constructor() {
        ...
        this.itms = [
            ...
            new SctItm('@KEIMP@で@KEIP@'),
            new SctItm('@KEIMP@だ'),
            new SctItm('@KEIDP@て@KEIMP@だ'),
            new SctItm('@KEIMP@で@KEIMP@だ'),
...
//---------------------------------------------------------------------------------------
class selector_kw extends SctItm_Selector {
    constructor() {
        super('@KEIW@');
...
class selector_kw2 extends SctItm_Selector {
    constructor() {
        super('@KEIW2@');
        this.itms = [
            new SctItm('@KEIW@'),
            new SctItm('@KEIDW@て@KEIW@'),
            new SctItm('@KEIMW@で@KEIW@'),
            new SctItm('@KEIMW@な'),
            new SctItm('@KEIDW@て@KEIMW@な'),
            new SctItm('@KEIMW@で@KEIMW@な'),
            new SctItm('@NICKSTRONG@のような'),
            new SctItm('@KEIDW@て@NICKSTRONG@のような'),
            new SctItm('@KEIMW@で@NICKSTRONG@のような')
        ];
    }
}
class selector_kw3 extends SctItm_Selector {
    constructor() {
        super('@KEIW3@');
        this.itms = [
            new SctItm('@KEIW@'),
            ...
            new SctItm('@KEIMW@で@KEIW@'),
            new SctItm('@KEIMW@だ'),
            new SctItm('@KEIDW@て@KEIMW@だ'),
            new SctItm('@KEIMW@で@KEIMW@だ'),
            new SctItm('@NICKSTRONG@のようだ'),
            new SctItm('@KEIDW@て@NICKSTRONG@のようだ'),
            new SctItm('@KEIMW@で@NICKSTRONG@のようだ')
        ];
    }
}
//---------------------------------------------------------------------------------------
...
//---------------------------------------------------------------------------------------
class selector_ks extends SctItm_Selector {
    constructor() {
        super('@KEIS@');
...
class selector_kds extends SctItm_Selector {
    constructor() {
        super('@KEIDS@');
...
class selector_kms extends SctItm_Selector {
    constructor() {
        super('@KEIMS@');
...
class selector_ks2 extends SctItm_Selector {
    constructor() {
        super('@KEIS2@');
        this.itms = [
            new SctItm('@KEIS@'),
            new SctItm('@KEIDS@て@KEIS@'),
            new SctItm('@KEIMS@で@KEIS@'),
            new SctItm('@KEIMS@な'),
            new SctItm('@KEIDS@て@KEIMS@な'),
            new SctItm('@KEIMS@で@KEIMS@な'),
            new SctItm('@NICKPOOR@みたいな'),
            new SctItm('@KEIDS@て@NICKPOOR@みたいな'),
            new SctItm('@KEIMS@で@NICKPOOR@みたいな')
        ];
    }
}
class selector_ks3 extends SctItm_Selector {
    constructor() {
        super('@KEIS3@');
        this.itms = [
            new SctItm('@KEIS@'),
            ...
            new SctItm('@NICKPOOR@みたいだ'),
            new SctItm('@KEIDS@て@NICKPOOR@みたいだ'),
            new SctItm('@KEIMS@で@NICKPOOR@みたいだ')
        ];
    }
}
//---------------------------------------------------------------------------------------
...
class locker_flowerCall01 extends SctItm_SelectLocker {
    constructor() {
...
class locker_flowerCall extends SctItm_SelectLocker {
    constructor() {
        super('@L_FLOWERCALL@');
        this.itms = [
...
class selector_school01 extends SctItm_Selector {
    constructor() {
        super('@SCHOOL01@');
        this.itms = [
...
class locker_king extends SctItm_SelectLocker {
    constructor() {
        super('@L_KING@');
        this.itms = [
...
class locker_king01 extends SctItm_SelectLocker {
    constructor() {
        super('@L_KING01@');
        this.Add(itms_King01);
    }
...
class locker_king02 extends SctItm_SelectLocker {
    constructor() {
        super('@L_KING02@');
        this.Add(itms_King02);
    }
}
class selector_king03 extends SctItm_Selector {
    constructor() {
        super('@KING03@');
        this.Add(itms_King03);
    }
}
class locker_king03 extends SctItm_SelectLocker {
    constructor() {
        super('@L_KING03@');
        this.Add(itms_King03);
    }
...
class selector_landmark01 extends SctItm_Selector {
    constructor() {
        super('@LANDMARK01@');
...
class locker_landmark01 extends SctItm_SelectLocker {
    constructor() {
        super('@L_LANDMARK01@');
        this.Add(itms_landmark);
    }
...
class selector_drink extends SctItm_Selector {
    constructor() {
        super('@DRINK@');
        this.Add(itms_drink);
    }
}
class locker_drink extends SctItm_SelectLocker {
    constructor() {
        super('@L_DRINK@');
        this.Add(itms_drink);
    }
}
class OneTime_drink extends SctItm_OneTimeLocker {
    constructor() {
        super('@O_DRINK@');
        this.Add(itms_drink);
    }
...
class selector_dress01 extends SctItm_Selector {
    constructor() {
        super('@DRESS01@');
        this.Add(itms_dress);
    }
...
class selector_under extends SctItm_Selector {
    constructor() {
        super('@UNDER@');
...
class locker_under extends SctItm_SelectLocker {
    constructor() {
        super('@L_UNDER@');
        this.Add(itms_underWare);
        this.Add(itms_shoes);
...
class selector_nickname extends SctItm_Selector {
    constructor() {
        ...
        this.Add(itms_nickStrong);
        this.Add(itms_nickPoor);
        this.Add(cods_to_itms(cods_animal.slice(1)));
        this.Add(cods_flower_spring.slice(1));
        this.Add(cods_flower_summer.slice(1));
        this.Add(cods_flower_autumn.slice(1));
...
class locker_nickname extends SctItm_SelectLocker {
    constructor() {
        super('@L_NICK@');
        this.Add(itms_nickNega);
        this.Add(itms_nickPosi);
...
class selector_nickStrong extends SctItm_Selector {
    constructor() {
        super('@NICKSTRONG@');
        this.Add(itms_nickStrong);
    }
}
class selector_nickPoor extends SctItm_Selector {
    constructor() {
        super('@NICKPOOR@');
        this.Add(itms_nickPoor);
    }
...
class selector_say01 extends SctItm_Selector {
    constructor() {
        super('@SAY01@');
        this.itms = [
...
class selector_say201 extends SctItm_Selector {
    constructor() {
        super('@SAY201@');
        this.itms = [
            // new SctItm('分析')
...
class selector_message02 extends SctItm_Selector {
    constructor() {
        super('@MESSAGE02@');
...
class selector_did01 extends SctItm_Selector {
    constructor() {
        super('@DID01@');
        this.itms = [
            new SctItm('@DID00@'),
...
// 行動 （食べ）ている　（食べ）た
class selector_did00 extends SctItm_Selector {
    constructor() {
        super('@DID00@');
        this.Add(itms_did);
    }
...
class selector_whereKind extends SctItm_Selector {
    constructor() {
        super('@WHEREKIND@');
        this.Add(itms_whereKind);
    }
}
class selector_whereCompany extends SctItm_Selector {
    constructor() {
        super('@WHERECOMPANY@');
        this.itms = [
...
class selector_whereCompany01 extends SctItm_Selector {
    constructor() {
        super('@WHERECOMPANY01@');
        this.Add(itms_whereCompany01);
    }
}
class selector_whereCompany02 extends SctItm_Selector {
    constructor() {
...
class selector_gitai extends SctItm_Selector {
    constructor() {
        super('@GITAI@');
        this.Add(itms_Gitai);
    }
}
class locker_gitai extends SctItm_SelectLocker {
    constructor() {
        super('@L_GITAI@');
        this.Add(itms_Gitai);
    }
}
class selector_greet extends SctItm_Selector {
    constructor() {
        super('@GREET@');
        this.Add(itms_Greet);
    }
}
class locker_greet extends SctItm_SelectLocker {
    constructor() {
        super('@L_GREET@');
        this.Add(itms_Greet);
    }
...
//     }
// }
class selector_club02 extends SctItm_Selector {
    constructor() {
        super('@CLUB02@');
        this.Add(itms_club);
    }
}
class locker_club02 extends SctItm_SelectLocker {
    constructor() {
        super('@L_CLUB02@');
        this.Add(itms_club);
    }
...
class selector_club extends SctItm_Selector {
    constructor() {
        super('@CLUB@');
        this.itms = [
...
class locker_companyname extends SctItm_SelectLocker {
    constructor() {
        super('@L_COMPANYNAME@');
        this.Add(itms_companyname);
    }
}
class locker_companyname01 extends SctItm_SelectLocker {
    constructor() {
...
class selector_companyclass extends SctItm_Selector {
    constructor() {
        super('@COMPANYCLASS@');
        this.Add(itms_companyclass);
    }
}
class locker_companyclass extends SctItm_SelectLocker {
    constructor() {
...
class selector_pen extends SctItm_Selector {
    constructor() {
        super('@PEN@');
        this.Add(cods_to_itms(cods_pen));
    }
}
class locker_pen extends SctItm_SelectLocker {
    constructor() {
        super('@L_PEN@');
        this.Add(cods_to_itms(cods_pen));
    }
}
class selector_toy extends SctItm_Selector {
    constructor() {
        super('@TOY@');
        this.Add(cods_to_itms(cods_toy));
    }
}
class locker_toy extends SctItm_SelectLocker {
    constructor() {
        super('@L_TOY@');
        this.Add(cods_to_itms(cods_toy));
    }
}
class selector_sword extends SctItm_Selector {
    constructor() {
        super('@SWORD@');
        this.Add(cods_to_itms(cods_sword));
    }
}
class locker_sword extends SctItm_SelectLocker {
    constructor() {
        super('@L_SWORD@');
        this.Add(cods_to_itms(cods_sword));
    }
...
class selector_powerItem extends SctItm_Selector {
    constructor() {
        super('@POWERITEM@');
        this.Add(cods_to_itms(cods_weapon.slice(1)));
        this.Add(cods_to_itms(cods_gun).slice(1));
        this.Add(cods_to_itms(cods_sword).slice(1));
        this.Add(itms_nickStrong);
    }
}
class locker_powerItem extends SctItm_SelectLocker {
    constructor() {
        super('@L_POWERITEM@');
        this.Add(cods_to_itms(cods_weapon).slice(1));
        this.Add(cods_to_itms(cods_gun).slice(1));
...
class news_docs_maker extends docs_maker {
    constructor() {
        ...
        this.dic_push(new selector_nickStrong());
        this.dic_push(new selector_nickPoor());
        ...
        this.dic_push(new selector_powerItem());
        this.dic_push(new locker_powerItem());
    }
}
