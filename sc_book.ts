...
class selector_storyH00 extends SctItm_Selector implements ISctItm_Selector {
    constructor(){
        super('@STH00@');
        this.itms = [
            new SctItm('そんな@KEIN@騒ぎを聞きつけ、@KEIDP@@KEIP@@L_HEROJOB@@L_HEROTYPE@が駆け付けた！<br>@STH01@')
            ,
            new SctItm('@KEIP@@MUSIC@と共に現れたのは、@KEIDP@@KEIP@@L_HEROJOB@@L_HEROTYPE@！<br>@STH01@')
            ,
            new SctItm('見るも@KEIP@@DRESS@をひるがえし、@KEIP@@L_HEROJOB@@L_HEROTYPE@が@KEIDP@@KEIDP@舞い降りた！<br>@STH01@')
            ,
            new SctItm('@KEIP@@FLOWER@の花を口にくわえた、@KEIP@@L_HEROJOB@@L_HEROTYPE@が降臨した！<br>@STH01@')
        ]
    }
}
...
class selector_storyH01 extends SctItm_Selector implements ISctItm_Selector {
    constructor(){
        super('@STH01@');
        this.itms = [
            new SctItm('「人呼んで@ITEM@の@NICKGOOD@！ @L_HEROFULLNAME@とは私のことだ！」<br>@SEL01@')
            ,
            new SctItm('「待たせたな！ この@L_HERO@が相手になろう！」<br>@SEL01@')
            ,
            new SctItm('「そこまでだ！ @L_HERO@が容赦はしないぞ！」<br>@SEL01@')
            ,
            new SctItm('「@L_HERO@、只今参上！」<br>@SEL01@')
        ]
    }
}
...
class selector_storyEEND extends SctItm_Selector implements ISctItm_Selector {
    constructor(){
        ...
        this.itms = [
            ...
            ,
            new SctItm('「悪が栄える！ これがこの世の真実だ！」<br>　@L_WHAT@は@KEIN@@L_EVILJOB@@L_EVILTYPE@の魔の手に落ちた！<br>　@HEROCATCH@@L_HERONAME@！　@HEROCATCH@@L_HERONAME@！<br>　@L_WHAT@があなたを待っている！<br>(続く)')
            ,
            new SctItm('「さあ、@L_CLASS@共よ！ 俺様に平伏すが良い！ ゲハハハ！」<br>　@L_EVILFULLNAME@の@KEIDN@@KEIN@大勝利！<br>　@HEROCATCH@@L_HERONAME@！　@HEROCATCH@@L_HERONAME@！<br>　@L_CLASS@達を救えるのは君だけだ！<br>(続く)')
        ]
    }
}
// END:住人勝利
class selector_storyCEND extends SctItm_Selector implements ISctItm_Selector {
    constructor(){
        super('@STCEND');
        this.itms = [
            new SctItm('　これぞ数の暴力！ @L_CLASS@達の大勝利！<br>「住民パワーで世界平和だ！」<br>　@HEROCATCH@@L_HERONAME@！ ついでに@HEROCATCH@@L_EVILNAME@！<br>　英雄達に未来は来るか？<br>(続く)')
            ,
            new SctItm('　正論には誰も勝てない！ @L_CLASS@達の大勝利！<br>「ペンは剣よりも強いのだ！」<br>　@HEROCATCH@@L_HERONAME@！ そして@HEROCATCH@@L_EVILNAME@！<br>　ヒーロー達の明日はどっちだ？<br>(続く)')
        ]
    }
}
...
class selector_storyE03 extends SctItm_Selector implements ISctItm_Selector {
    constructor(){
        super('@STE03@');
        this.itms = [
            new SctItm('　それを@L_EVILJOB@@L_EVILTYPE@はガッチリ受け止め、「フン、この程度か！　@EVILATTACK@」<br>@STH04@')
            ,
            new SctItm('　それを@L_EVILJOB@@L_EVILTYPE@は払いのけ、「そんな@NICKBAD@みたいな技が効くものか！　@EVILATTACK@」<br>@STH04@')
            ,
            new SctItm('　しかし、@L_EVILJOB@@L_EVILTYPE@には通じない！ 「フハハ、俺様の勝ちだ！　@EVILATTACK@」<br>@STH04@')
        ]
    }
}
...
class selector_storyH_C2 extends SctItm_Selector implements ISctItm_Selector {
    constructor(){
        super('@STH_C2@');
        this.itms = [
            new SctItm('　しかし、@L_WHAT@の@L_CLASS@達は認めない！<br> 「なんてことするんだ！ 暴力反対！」<br>「貴様も同じ、@KEIN@乱暴者ではないか！」<br><br>@STHLOSE@')
            ,
            new SctItm('　何故か、@L_WHAT@の@L_CLASS@達は怒りだした！<br> 「相手が悪人だからって乱暴は良くない！」<br>「それで平和になると思うのか！」<br><br>@STHLOSE@')
            ,
            new SctItm('　まだ、@L_WHAT@の@L_CLASS@達の恐怖は収まらない！<br> 「正義の味方？ どちらも同じじゃ無いか！」<br>「近づくな！ @KEIN@乱暴者は出て行け！」<br><br>@STHLOSE@')
        ]
    }
}
...
class selector_storyHLose extends SctItm_Selector implements ISctItm_Selector {
    constructor(){
        ...
        this.itms = [
            ...
            ,
            new SctItm('　――@L_HEROFULLNAME@は行き場を失った。<br>「次は@CLASS@に転職するかな・・・」<br>　@HEROCATCH@@L_HERONAME@！ @HEROCATCH@@L_HERONAME@！<br>　@CLASS@も悪くないぞ！<br>(続く)')
            ,
            new SctItm('　@L_WHAT@から追われた@L_HEROFULLNAME@を待っていたのは、かつてのライバル、@L_EVILFULLNAME@であった。<br>「もう終わったんだ。俺達の時代は」「ああ、そうだな――」<br>　酒を酌み交わす英雄が二人・・・。<br>　@HEROCATCH@@L_HERONAME@！ @HEROCATCH@@L_EVILNAME@！<br>　プロレス界が君達を待っている！<br>(続く)')
            ,
            new SctItm('　@L_CLASS@から追いやられた@L_HEROFULLNAME@の側に、もはや敵ではなくなった、@L_EVILFULLNAME@の姿があった。<br>「――判ったか？ 俺達のすべきことが」「ああ、そうだな――」<br>　勇者の手に、<KEIDP><KEIN>武器が手渡されていた。<br>　@HEROCATCH@@L_HERONAME@！ @HEROCATCH@@L_EVILNAME@！<br>　世論を敵に回して勝てるのか？<br>(続く)')
            ,
            new SctItm('　荷物をかかえて@L_WHAT@を後にする@L_HEROFULLNAME@を、ジッと見守る@L_EVILFULLNAME@の姿。<br>　これが二人の愛が始まる瞬間であった――。<br>　@HEROCATCH@@L_HERONAME@！ @HEROCATCH@@L_EVILNAME@！<br>　プロポーズまで先は長いぞ！<br>(続く)')
        ]
    }
}
...
class selector_storyC01 extends SctItm_Selector implements ISctItm_Selector {
    constructor(){
        ...
        this.itms = [
            ...
            ,
            new SctItm('　@L_HERONAME@は言い訳するが、@L_CLASS@達は問答無用、「謝罪しろ！ @CLASSATTACK@」<br>@STH05@')
            ,
            new SctItm('　思わず逃げ出そうとする@L_HERONAME@を、@L_CLASS@達は取り囲み、「落ちぶれてしまえ！ @CLASSATTACK@」<br>@STH05@')
        ]
    }
}
