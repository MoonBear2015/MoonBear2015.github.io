...
// 登場
class selector_story01 extends SctItm_Selector implements ISctItm_Selector {
    constructor(){
        super('@STORY01@');
        this.itms = [
            ...
            ,
            new SctItm('その@L_WHAT@に、@KEIN@@L_EVILTYPE@が訪れました。その名も@L_EVILNAME@。')
            ,
            new SctItm('そんな@KEIP@@L_WHAT@に@KEIN@姿の@L_EVILTYPE@がやってきました。@L_CLASS@達は驚いて尋ねました。「なんて@KEIN@奴だ。 貴様は誰だ？」')
        ]
    }
}
class selector_story02 extends SctItm_Selector implements ISctItm_Selector {
    constructor(){
        super('@STORY02@');
        this.itms = [
...
class selector_story03 extends SctItm_Selector implements ISctItm_Selector {
    constructor(){
        super('@STORY03@');
        this.itms = [
...
class selector_story04 extends SctItm_Selector implements ISctItm_Selector {
    constructor(){
        super('@STORY04@');
        this.itms = [
